...
if __name__ == "__main__":
    ...
    patch_size, depth, num_hidden, num_steps, num_labels = 5, 16, 64, 1001, 10
    ...
    with graph.as_default():
        ...
        W = [ tf.Variable(tf.truncated_normal([patch_size, patch_size, channels, depth], stddev=0.1)), \
              ...
              tf.Variable(tf.truncated_normal([int(image_size // 4 * image_size // 4 * depth), num_hidden], stddev=0.1)), \
